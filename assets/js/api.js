...
// options.timeout lets a slow-but-legitimate call (AI chat) wait longer
// than the default before the browser gives up — omit it and this behaves
// exactly as before.
export function post(path, body, options = {}) {
  return api(path, { method: "POST", body: JSON.stringify(body || {}), timeout: options.timeout });
}
